$(document).ready(function($){
	...
	$(".errorTxt").hide();
		...
		$("#iniciar-sesion").click(function() {
			...
			$(".errorTxt").show();
			}else if(contraseña.length = 0 || contraseña.length < 5){
				$(".errorTxt2").show();
			}else{
				e.preventDefault();
	...
	/*for(var i=0;i<localStorage.length;i++){
		var clave = localStorage.setItem(i,numId);
	}*/
	//PERFIL
	/*localStorage.getItem(user);
	$(".email-perfil").append("<p>"+user+"</p>")*/
	
	/*$(".agregar-tarj").click(function(){
		for(var i=0;i<localStorage.length;i++){
		var clave = localStorage(i,numId);
		}*/
